...
function mytheme_add_admin() {
	...
	*/	
	...
	add_menu_page('Page title', 'Christmas', 10, 'FMS-Info', 'fms_info');
	add_submenu_page('FMS-Info', 'Christmas  - Info', 'Info', 10, 'FMS-Info', 'fms_info');
	add_submenu_page('FMS-Info', 'Christmas  - Settings', 'Settings', 10, 'FMS-Header', 'fms_header');
...
function fms_info() {
	...
	?>
	<div class="wrap">
	<h2><?php echo $themename." - Info"; ?></h2>
	<img src="<?php bloginfo('template_url'); ?>/admin/images/fms.png" alt="Post It " class="magbasic" />
	<p>Thanks for downloading <strong> Christmas </strong> by Linesh Jose. Hope you enjoy using it!</p>
	...
	<p>A lot of hard work went in to programming and designing <strong> Christmas </strong>, and if you would like to support Linesh Jose (the guy who designed it) please use the donate link below.   </p>
...
<img alt="" border="0" src="https://www.paypal.com/en_GB/i/scr/pixel.gif" width="1" height="1">
	...
	<p>If you have any questions, comments, or if you encounter a bug, please <a href="http://lineshjose.info/">contact me</a>.</p>
	</div>
<?php 
}
